# Invoice Readiness Board Forking Guide

Use this guide to adapt the demo without introducing private data or hidden dependencies.

## Public-Safe Sample Scenario

- Service line: Invoice and closeout operations
- Demo promise: Check deliverables, approvals, payment path, blockers, and receipt-readiness for fictional projects.
- Fictional sample object: closeout tracker
...
Fork Invoice Readiness Board as a public-safe client demo for invoice and closeout operations. Keep all records fictional, update `src/data.ts`, preserve the readiness board and export flow, and publish only after the build passes.
