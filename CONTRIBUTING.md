# Contributing to Invoice Readiness Board

Invoice Readiness Board is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A closeout board for deliverables, approvals, blockers, payment path, and status before billing.
